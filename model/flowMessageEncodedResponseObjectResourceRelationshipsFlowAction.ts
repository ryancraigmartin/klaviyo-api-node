...
export class FlowMessageEncodedResponseObjectResourceRelationshipsFlowAction {
    ...
    static getAttributeTypeMap() {
        return FlowMessageEncodedResponseObjectResourceRelationshipsFlowAction.attributeTypeMap;
    }
}
