...
export class TextBlockStylesV1 {
    ...
    * Border style.
    */
    'blockBorderStyle'?: TextBlockStylesV1.BlockBorderStyleEnum | 'dashed' | 'dotted' | 'groove' | 'inset' | 'none' | 'outset' | 'ridge' | 'solid' | null;
    ...
    * Font style.
    */
    'fontStyle'?: TextBlockStylesV1.FontStyleEnum | 'italic' | 'normal' | null;
    ...
    * Text Alignment.
    */
    'textAlign'?: TextBlockStylesV1.TextAlignEnum | 'center' | 'left' | 'right' | null;
    'textDecoration'?: string | null;
    /**
    * Text table layout.
    */
    'textTableLayout'?: TextBlockStylesV1.TextTableLayoutEnum | 'auto' | 'fixed' | 'inherit' | 'initial' | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "TextBlockStylesV1.BlockBorderStyleEnum"
        },
        {
        ...
        },
        {
            "name": "fontStyle",
            "baseName": "font_style",
            "type": "TextBlockStylesV1.FontStyleEnum"
        },
        {
            "name": "fontWeight",
        ...
        },
        {
            "name": "textAlign",
            "baseName": "text_align",
            "type": "TextBlockStylesV1.TextAlignEnum"
        },
        {
            "name": "textDecoration",
        ...
        },
        {
            ...
            "type": "TextBlockStylesV1.TextTableLayoutEnum"
        }    ];

    static getAttributeTypeMap() {
        return TextBlockStylesV1.attributeTypeMap;
    }
}

export namespace TextBlockStylesV1 {
