...
export class TextBlockStylesV0 {
    ...
    * Border style.
    */
    'blockBorderStyle'?: TextBlockStylesV0.BlockBorderStyleEnum | 'dashed' | 'dotted' | 'groove' | 'inset' | 'none' | 'outset' | 'ridge' | 'solid' | null;
    ...
    * Font style.
    */
    'fontStyle'?: TextBlockStylesV0.FontStyleEnum | 'italic' | 'normal' | null;
    ...
    * Text Alignment.
    */
    'textAlign'?: TextBlockStylesV0.TextAlignEnum | 'center' | 'left' | 'right' | null;
    'textDecoration'?: string | null;
    /**
    * Text table layout.
    */
    'textTableLayout'?: TextBlockStylesV0.TextTableLayoutEnum | 'auto' | 'fixed' | 'inherit' | 'initial' | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "TextBlockStylesV0.BlockBorderStyleEnum"
        },
        {
        ...
        },
        {
            "name": "fontStyle",
            "baseName": "font_style",
            "type": "TextBlockStylesV0.FontStyleEnum"
        },
        {
            "name": "fontWeight",
        ...
        },
        {
            "name": "textAlign",
            "baseName": "text_align",
            "type": "TextBlockStylesV0.TextAlignEnum"
        },
        {
            "name": "textDecoration",
        ...
        },
        {
            ...
            "type": "TextBlockStylesV0.TextTableLayoutEnum"
        }    ];

    static getAttributeTypeMap() {
        return TextBlockStylesV0.attributeTypeMap;
    }
}

export namespace TextBlockStylesV0 {
