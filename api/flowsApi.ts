...
export class FlowsApi {
     ...
     * @param id 
     * @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets
     */
    public async getActionForFlowMessage (id: string, options: { fieldsFlowAction?: Array<'created' | 'definition' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.data.branches' | 'definition.data.current_experiment' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.winner_metric' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.experiment_status' | 'definition.data.list_id' | 'definition.data.main_action' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.android_link' | 'definition.data.main_action.data.message.badge' | 'definition.data.main_action.data.message.badge_options' | 'definition.data.main_action.data.message.badge_options.badge_config' | 'definition.data.main_action.data.message.badge_options.set_from_property' | 'definition.data.main_action.data.message.badge_options.value' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.conversion_metric_id' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.ios_link' | 'definition.data.main_action.data.message.kv_pairs' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.on_open' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.push_type' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.main_action.data.message.sound' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.title' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.video_asset_id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.id' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.message' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.android_link' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.badge_options.value' | 'definition.data.message.bcc_email' | 'definition.data.message.body' | 'definition.data.message.cc_email' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.dynamic_image' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.headers' | 'definition.data.message.id' | 'definition.data.message.image_id' | 'definition.data.message.include_contact_card' | 'definition.data.message.ios_link' | 'definition.data.message.kv_pairs' | 'definition.data.message.name' | 'definition.data.message.on_open' | 'definition.data.message.preview_text' | 'definition.data.message.push_type' | 'definition.data.message.reply_to_email' | 'definition.data.message.shorten_links' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.sound' | 'definition.data.message.subject_line' | 'definition.data.message.template_id' | 'definition.data.message.title' | 'definition.data.message.to_emails' | 'definition.data.message.transactional' | 'definition.data.message.url' | 'definition.data.message.vendor_id' | 'definition.data.message.video_asset_id' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.profile_operations' | 'definition.data.secondary_value' | 'definition.data.service_configuration' | 'definition.data.service_configuration.event_key' | 'definition.data.service_configuration.event_payload' | 'definition.data.service_configuration.report_id' | 'definition.data.service_configuration.service_method_type' | 'definition.data.service_configuration.tracking_company_id' | 'definition.data.status' | 'definition.data.target_days' | 'definition.data.target_time' | 'definition.data.timezone' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_subtype' | 'definition.data.trigger_type' | 'definition.data.unit' | 'definition.data.value' | 'definition.id' | 'definition.links' | 'definition.links.next' | 'definition.links.next_if_false' | 'definition.links.next_if_true' | 'definition.temporary_id' | 'definition.type' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponse;  }> {
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponse;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetFlowActionEncodedResponse");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     * @param id 
     * @param filter For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;&lt;br&gt;&#x60;action_type&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;status&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sorting
     */
    ...
    public async getActionsForFlow (id: string, options: { fieldsFlowAction?: Array<'created' | 'definition' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.data.branches' | 'definition.data.current_experiment' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.winner_metric' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.experiment_status' | 'definition.data.list_id' | 'definition.data.main_action' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.android_link' | 'definition.data.main_action.data.message.badge' | 'definition.data.main_action.data.message.badge_options' | 'definition.data.main_action.data.message.badge_options.badge_config' | 'definition.data.main_action.data.message.badge_options.set_from_property' | 'definition.data.main_action.data.message.badge_options.value' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.conversion_metric_id' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.ios_link' | 'definition.data.main_action.data.message.kv_pairs' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.on_open' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.push_type' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.main_action.data.message.sound' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.title' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.video_asset_id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.id' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.message' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.android_link' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.badge_options.value' | 'definition.data.message.bcc_email' | 'definition.data.message.body' | 'definition.data.message.cc_email' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.dynamic_image' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.headers' | 'definition.data.message.id' | 'definition.data.message.image_id' | 'definition.data.message.include_contact_card' | 'definition.data.message.ios_link' | 'definition.data.message.kv_pairs' | 'definition.data.message.name' | 'definition.data.message.on_open' | 'definition.data.message.preview_text' | 'definition.data.message.push_type' | 'definition.data.message.reply_to_email' | 'definition.data.message.shorten_links' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.sound' | 'definition.data.message.subject_line' | 'definition.data.message.template_id' | 'definition.data.message.title' | 'definition.data.message.to_emails' | 'definition.data.message.transactional' | 'definition.data.message.url' | 'definition.data.message.vendor_id' | 'definition.data.message.video_asset_id' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.profile_operations' | 'definition.data.secondary_value' | 'definition.data.service_configuration' | 'definition.data.service_configuration.event_key' | 'definition.data.service_configuration.event_payload' | 'definition.data.service_configuration.report_id' | 'definition.data.service_configuration.service_method_type' | 'definition.data.service_configuration.tracking_company_id' | 'definition.data.status' | 'definition.data.target_days' | 'definition.data.target_time' | 'definition.data.timezone' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_subtype' | 'definition.data.trigger_type' | 'definition.data.unit' | 'definition.data.value' | 'definition.id' | 'definition.links' | 'definition.links.next' | 'definition.links.next_if_false' | 'definition.links.next_if_true' | 'definition.temporary_id' | 'definition.type' | 'updated'>, filter?: string, pageCursor?: string, pageSize?: number, sort?: 'action_type' | '-action_type' | 'created' | '-created' | 'id' | '-id' | 'status' | '-status' | 'updated' | '-updated',  } = {}): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponseCollection;  }> {
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponseCollection;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetFlowActionEncodedResponseCollection");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     * @summary Get Flow
     * @param id 
     * @param additionalFieldsFlow Request additional fields not included by default in the response. Supported values: \&#39;definition\&#39;* @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param fieldsTag For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#relationships
     */
    public async getFlow (id: string, options: { additionalFieldsFlow?: Array<'definition'>, fieldsFlowAction?: Array<'created' | 'definition' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.data.branches' | 'definition.data.current_experiment' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.winner_metric' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.experiment_status' | 'definition.data.list_id' | 'definition.data.main_action' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.android_link' | 'definition.data.main_action.data.message.badge' | 'definition.data.main_action.data.message.badge_options' | 'definition.data.main_action.data.message.badge_options.badge_config' | 'definition.data.main_action.data.message.badge_options.set_from_property' | 'definition.data.main_action.data.message.badge_options.value' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.conversion_metric_id' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.ios_link' | 'definition.data.main_action.data.message.kv_pairs' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.on_open' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.push_type' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.main_action.data.message.sound' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.title' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.video_asset_id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.id' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.message' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.android_link' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.badge_options.value' | 'definition.data.message.bcc_email' | 'definition.data.message.body' | 'definition.data.message.cc_email' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.dynamic_image' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.headers' | 'definition.data.message.id' | 'definition.data.message.image_id' | 'definition.data.message.include_contact_card' | 'definition.data.message.ios_link' | 'definition.data.message.kv_pairs' | 'definition.data.message.name' | 'definition.data.message.on_open' | 'definition.data.message.preview_text' | 'definition.data.message.push_type' | 'definition.data.message.reply_to_email' | 'definition.data.message.shorten_links' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.sound' | 'definition.data.message.subject_line' | 'definition.data.message.template_id' | 'definition.data.message.title' | 'definition.data.message.to_emails' | 'definition.data.message.transactional' | 'definition.data.message.url' | 'definition.data.message.vendor_id' | 'definition.data.message.video_asset_id' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.profile_operations' | 'definition.data.secondary_value' | 'definition.data.service_configuration' | 'definition.data.service_configuration.event_key' | 'definition.data.service_configuration.event_payload' | 'definition.data.service_configuration.report_id' | 'definition.data.service_configuration.service_method_type' | 'definition.data.service_configuration.tracking_company_id' | 'definition.data.status' | 'definition.data.target_days' | 'definition.data.target_time' | 'definition.data.timezone' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_subtype' | 'definition.data.trigger_type' | 'definition.data.unit' | 'definition.data.value' | 'definition.id' | 'definition.links' | 'definition.links.next' | 'definition.links.next_if_false' | 'definition.links.next_if_true' | 'definition.temporary_id' | 'definition.type' | 'updated'>, fieldsFlow?: Array<'archived' | 'created' | 'definition' | 'definition.actions' | 'definition.entry_action_id' | 'definition.profile_filter' | 'definition.profile_filter.condition_groups' | 'definition.reentry_criteria' | 'definition.reentry_criteria.duration' | 'definition.reentry_criteria.unit' | 'definition.triggers' | 'name' | 'status' | 'trigger_type' | 'updated'>, fieldsTag?: Array<'name'>, include?: Array<'flow-actions' | 'tags'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowV2ResponseCompoundDocument;  }> {
        ...
        if (options.fieldsFlow !== undefined) {
            localVarQueryParameters['fields[flow]'] = ObjectSerializer.serialize(options.fieldsFlow, "Array<'archived' | 'created' | 'definition' | 'definition.actions' | 'definition.entry_action_id' | 'definition.profile_filter' | 'definition.profile_filter.condition_groups' | 'definition.reentry_criteria' | 'definition.reentry_criteria.duration' | 'definition.reentry_criteria.unit' | 'definition.triggers' | 'name' | 'status' | 'trigger_type' | 'updated'>");
        }
     ...
     * @param id 
     * @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param fieldsFlowMessage For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#relationships
     */
    public async getFlowAction (id: string, options: { fieldsFlowAction?: Array<'created' | 'definition' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.data.branches' | 'definition.data.current_experiment' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.winner_metric' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.experiment_status' | 'definition.data.list_id' | 'definition.data.main_action' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.android_link' | 'definition.data.main_action.data.message.badge' | 'definition.data.main_action.data.message.badge_options' | 'definition.data.main_action.data.message.badge_options.badge_config' | 'definition.data.main_action.data.message.badge_options.set_from_property' | 'definition.data.main_action.data.message.badge_options.value' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.conversion_metric_id' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.ios_link' | 'definition.data.main_action.data.message.kv_pairs' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.on_open' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.push_type' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.main_action.data.message.sound' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.title' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.video_asset_id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.id' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.message' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.android_link' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.badge_options.value' | 'definition.data.message.bcc_email' | 'definition.data.message.body' | 'definition.data.message.cc_email' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.dynamic_image' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.headers' | 'definition.data.message.id' | 'definition.data.message.image_id' | 'definition.data.message.include_contact_card' | 'definition.data.message.ios_link' | 'definition.data.message.kv_pairs' | 'definition.data.message.name' | 'definition.data.message.on_open' | 'definition.data.message.preview_text' | 'definition.data.message.push_type' | 'definition.data.message.reply_to_email' | 'definition.data.message.shorten_links' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.sound' | 'definition.data.message.subject_line' | 'definition.data.message.template_id' | 'definition.data.message.title' | 'definition.data.message.to_emails' | 'definition.data.message.transactional' | 'definition.data.message.url' | 'definition.data.message.vendor_id' | 'definition.data.message.video_asset_id' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.profile_operations' | 'definition.data.secondary_value' | 'definition.data.service_configuration' | 'definition.data.service_configuration.event_key' | 'definition.data.service_configuration.event_payload' | 'definition.data.service_configuration.report_id' | 'definition.data.service_configuration.service_method_type' | 'definition.data.service_configuration.tracking_company_id' | 'definition.data.status' | 'definition.data.target_days' | 'definition.data.target_time' | 'definition.data.timezone' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_subtype' | 'definition.data.trigger_type' | 'definition.data.unit' | 'definition.data.value' | 'definition.id' | 'definition.links' | 'definition.links.next' | 'definition.links.next_if_false' | 'definition.links.next_if_true' | 'definition.temporary_id' | 'definition.type' | 'updated'>, fieldsFlowMessage?: Array<'channel' | 'created' | 'definition' | 'definition.add_info_link' | 'definition.add_opt_out_language' | 'definition.add_org_prefix' | 'definition.add_tracking_params' | 'definition.additional_filters' | 'definition.additional_filters.condition_groups' | 'definition.android_link' | 'definition.badge' | 'definition.badge_options' | 'definition.badge_options.badge_config' | 'definition.badge_options.set_from_property' | 'definition.badge_options.value' | 'definition.bcc_email' | 'definition.body' | 'definition.cc_email' | 'definition.conversion_metric_id' | 'definition.custom_tracking_params' | 'definition.dynamic_image' | 'definition.from_email' | 'definition.from_label' | 'definition.headers' | 'definition.id' | 'definition.image_id' | 'definition.include_contact_card' | 'definition.ios_link' | 'definition.kv_pairs' | 'definition.name' | 'definition.on_open' | 'definition.preview_text' | 'definition.push_type' | 'definition.reply_to_email' | 'definition.shorten_links' | 'definition.smart_sending_enabled' | 'definition.sms_quiet_hours_enabled' | 'definition.sound' | 'definition.subject_line' | 'definition.template_id' | 'definition.title' | 'definition.to_emails' | 'definition.transactional' | 'definition.url' | 'definition.vendor_id' | 'definition.video_asset_id' | 'updated'>, fieldsFlow?: Array<'archived' | 'created' | 'name' | 'status' | 'trigger_type' | 'updated'>, include?: Array<'flow' | 'flow-messages'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponseCompoundDocument;  }> {
        ...
        if (options.fieldsFlowMessage !== undefined) {
            localVarQueryParameters['fields[flow-message]'] = ObjectSerializer.serialize(options.fieldsFlowMessage, "Array<'channel' | 'created' | 'definition' | 'definition.add_info_link' | 'definition.add_opt_out_language' | 'definition.add_org_prefix' | 'definition.add_tracking_params' | 'definition.additional_filters' | 'definition.additional_filters.condition_groups' | 'definition.android_link' | 'definition.badge' | 'definition.badge_options' | 'definition.badge_options.badge_config' | 'definition.badge_options.set_from_property' | 'definition.badge_options.value' | 'definition.bcc_email' | 'definition.body' | 'definition.cc_email' | 'definition.conversion_metric_id' | 'definition.custom_tracking_params' | 'definition.dynamic_image' | 'definition.from_email' | 'definition.from_label' | 'definition.headers' | 'definition.id' | 'definition.image_id' | 'definition.include_contact_card' | 'definition.ios_link' | 'definition.kv_pairs' | 'definition.name' | 'definition.on_open' | 'definition.preview_text' | 'definition.push_type' | 'definition.reply_to_email' | 'definition.shorten_links' | 'definition.smart_sending_enabled' | 'definition.sms_quiet_hours_enabled' | 'definition.sound' | 'definition.subject_line' | 'definition.template_id' | 'definition.title' | 'definition.to_emails' | 'definition.transactional' | 'definition.url' | 'definition.vendor_id' | 'definition.video_asset_id' | 'updated'>");
        }
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetFlowActionEncodedResponseCompoundDocument;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetFlowActionEncodedResponseCompoundDocument");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     * @param id 
     * @param fieldsFlowMessage For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;&lt;br&gt;&#x60;name&#x60;: &#x60;contains&#x60;, &#x60;ends-with&#x60;, &#x60;equals&#x60;, &#x60;starts-with&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sorting
     */
    public async getFlowActionMessages (id: string, options: { fieldsFlowMessage?: Array<'channel' | 'created' | 'definition' | 'definition.add_info_link' | 'definition.add_opt_out_language' | 'definition.add_org_prefix' | 'definition.add_tracking_params' | 'definition.additional_filters' | 'definition.additional_filters.condition_groups' | 'definition.android_link' | 'definition.badge' | 'definition.badge_options' | 'definition.badge_options.badge_config' | 'definition.badge_options.set_from_property' | 'definition.badge_options.value' | 'definition.bcc_email' | 'definition.body' | 'definition.cc_email' | 'definition.conversion_metric_id' | 'definition.custom_tracking_params' | 'definition.dynamic_image' | 'definition.from_email' | 'definition.from_label' | 'definition.headers' | 'definition.id' | 'definition.image_id' | 'definition.include_contact_card' | 'definition.ios_link' | 'definition.kv_pairs' | 'definition.name' | 'definition.on_open' | 'definition.preview_text' | 'definition.push_type' | 'definition.reply_to_email' | 'definition.shorten_links' | 'definition.smart_sending_enabled' | 'definition.sms_quiet_hours_enabled' | 'definition.sound' | 'definition.subject_line' | 'definition.template_id' | 'definition.title' | 'definition.to_emails' | 'definition.transactional' | 'definition.url' | 'definition.vendor_id' | 'definition.video_asset_id' | 'updated'>, filter?: string, pageCursor?: string, pageSize?: number, sort?: 'created' | '-created' | 'id' | '-id' | 'name' | '-name' | 'updated' | '-updated',  } = {}): Promise<{ response: AxiosResponse; body: GetFlowMessageEncodedResponseCollection;  }> {
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetFlowMessageEncodedResponseCollection;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetFlowMessageEncodedResponseCollection");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     */
    public async getFlowForFlowAction (id: string, options: { fieldsFlow?: Array<'archived' | 'created' | 'name' | 'status' | 'trigger_type' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowResponse;  }> {
    ...
    /**
     * Get a flow message from a flow with the given flow message ID.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`  **Scopes:** `flows:read`
     * @summary Get Flow Message
     * @param id 
     * @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param fieldsFlowMessage For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param fieldsTemplate For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param include For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#relationships
     */
    public async getFlowMessage (id: string, options: { fieldsFlowAction?: Array<'created' | 'definition' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.data.branches' | 'definition.data.current_experiment' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.winner_metric' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.experiment_status' | 'definition.data.list_id' | 'definition.data.main_action' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.android_link' | 'definition.data.main_action.data.message.badge' | 'definition.data.main_action.data.message.badge_options' | 'definition.data.main_action.data.message.badge_options.badge_config' | 'definition.data.main_action.data.message.badge_options.set_from_property' | 'definition.data.main_action.data.message.badge_options.value' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.conversion_metric_id' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.ios_link' | 'definition.data.main_action.data.message.kv_pairs' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.on_open' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.push_type' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.main_action.data.message.sound' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.title' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.video_asset_id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.id' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.message' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.android_link' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.badge_options.value' | 'definition.data.message.bcc_email' | 'definition.data.message.body' | 'definition.data.message.cc_email' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.dynamic_image' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.headers' | 'definition.data.message.id' | 'definition.data.message.image_id' | 'definition.data.message.include_contact_card' | 'definition.data.message.ios_link' | 'definition.data.message.kv_pairs' | 'definition.data.message.name' | 'definition.data.message.on_open' | 'definition.data.message.preview_text' | 'definition.data.message.push_type' | 'definition.data.message.reply_to_email' | 'definition.data.message.shorten_links' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.sound' | 'definition.data.message.subject_line' | 'definition.data.message.template_id' | 'definition.data.message.title' | 'definition.data.message.to_emails' | 'definition.data.message.transactional' | 'definition.data.message.url' | 'definition.data.message.vendor_id' | 'definition.data.message.video_asset_id' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.profile_operations' | 'definition.data.secondary_value' | 'definition.data.service_configuration' | 'definition.data.service_configuration.event_key' | 'definition.data.service_configuration.event_payload' | 'definition.data.service_configuration.report_id' | 'definition.data.service_configuration.service_method_type' | 'definition.data.service_configuration.tracking_company_id' | 'definition.data.status' | 'definition.data.target_days' | 'definition.data.target_time' | 'definition.data.timezone' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_subtype' | 'definition.data.trigger_type' | 'definition.data.unit' | 'definition.data.value' | 'definition.id' | 'definition.links' | 'definition.links.next' | 'definition.links.next_if_false' | 'definition.links.next_if_true' | 'definition.temporary_id' | 'definition.type' | 'updated'>, fieldsFlowMessage?: Array<'channel' | 'created' | 'definition' | 'definition.add_info_link' | 'definition.add_opt_out_language' | 'definition.add_org_prefix' | 'definition.add_tracking_params' | 'definition.additional_filters' | 'definition.additional_filters.condition_groups' | 'definition.android_link' | 'definition.badge' | 'definition.badge_options' | 'definition.badge_options.badge_config' | 'definition.badge_options.set_from_property' | 'definition.badge_options.value' | 'definition.bcc_email' | 'definition.body' | 'definition.cc_email' | 'definition.conversion_metric_id' | 'definition.custom_tracking_params' | 'definition.dynamic_image' | 'definition.from_email' | 'definition.from_label' | 'definition.headers' | 'definition.id' | 'definition.image_id' | 'definition.include_contact_card' | 'definition.ios_link' | 'definition.kv_pairs' | 'definition.name' | 'definition.on_open' | 'definition.preview_text' | 'definition.push_type' | 'definition.reply_to_email' | 'definition.shorten_links' | 'definition.smart_sending_enabled' | 'definition.sms_quiet_hours_enabled' | 'definition.sound' | 'definition.subject_line' | 'definition.template_id' | 'definition.title' | 'definition.to_emails' | 'definition.transactional' | 'definition.url' | 'definition.vendor_id' | 'definition.video_asset_id' | 'updated'>, fieldsTemplate?: Array<'amp' | 'created' | 'editor_type' | 'html' | 'name' | 'text' | 'updated'>, include?: Array<'flow-action' | 'template'>,  } = {}): Promise<{ response: AxiosResponse; body: GetFlowMessageEncodedResponseCompoundDocument;  }> {
        ...
        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: GetFlowMessageEncodedResponseCompoundDocument;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "GetFlowMessageEncodedResponseCompoundDocument");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
     ...
     * @param fieldsFlowAction For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param fieldsFlow For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param fieldsTag For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets* @param filter For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;&lt;br&gt;&#x60;name&#x60;: &#x60;contains&#x60;, &#x60;ends-with&#x60;, &#x60;equals&#x60;, &#x60;starts-with&#x60;&lt;br&gt;&#x60;status&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;archived&#x60;: &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;trigger_type&#x60;: &#x60;equals&#x60;* @param include For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#relationships* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sorting
     */
    public async getFlows (options: { fieldsFlowAction?: Array<'created' | 'definition' | 'definition.data' | 'definition.data.action_output_filter' | 'definition.data.action_output_filter.condition_groups' | 'definition.data.branches' | 'definition.data.current_experiment' | 'definition.data.current_experiment.allocations' | 'definition.data.current_experiment.automatic_winner_selection_settings' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_date' | 'definition.data.current_experiment.automatic_winner_selection_settings.automatic_end_statistical_certainty' | 'definition.data.current_experiment.automatic_winner_selection_settings.enabled' | 'definition.data.current_experiment.id' | 'definition.data.current_experiment.name' | 'definition.data.current_experiment.started' | 'definition.data.current_experiment.variations' | 'definition.data.current_experiment.winner_metric' | 'definition.data.delay_until_time' | 'definition.data.delay_until_weekdays' | 'definition.data.experiment_status' | 'definition.data.list_id' | 'definition.data.main_action' | 'definition.data.main_action.data' | 'definition.data.main_action.data.message' | 'definition.data.main_action.data.message.add_info_link' | 'definition.data.main_action.data.message.add_opt_out_language' | 'definition.data.main_action.data.message.add_org_prefix' | 'definition.data.main_action.data.message.add_tracking_params' | 'definition.data.main_action.data.message.additional_filters' | 'definition.data.main_action.data.message.additional_filters.condition_groups' | 'definition.data.main_action.data.message.android_link' | 'definition.data.main_action.data.message.badge' | 'definition.data.main_action.data.message.badge_options' | 'definition.data.main_action.data.message.badge_options.badge_config' | 'definition.data.main_action.data.message.badge_options.set_from_property' | 'definition.data.main_action.data.message.badge_options.value' | 'definition.data.main_action.data.message.bcc_email' | 'definition.data.main_action.data.message.body' | 'definition.data.main_action.data.message.cc_email' | 'definition.data.main_action.data.message.conversion_metric_id' | 'definition.data.main_action.data.message.custom_tracking_params' | 'definition.data.main_action.data.message.dynamic_image' | 'definition.data.main_action.data.message.from_email' | 'definition.data.main_action.data.message.from_label' | 'definition.data.main_action.data.message.id' | 'definition.data.main_action.data.message.image_id' | 'definition.data.main_action.data.message.include_contact_card' | 'definition.data.main_action.data.message.ios_link' | 'definition.data.main_action.data.message.kv_pairs' | 'definition.data.main_action.data.message.name' | 'definition.data.main_action.data.message.on_open' | 'definition.data.main_action.data.message.preview_text' | 'definition.data.main_action.data.message.push_type' | 'definition.data.main_action.data.message.reply_to_email' | 'definition.data.main_action.data.message.shorten_links' | 'definition.data.main_action.data.message.smart_sending_enabled' | 'definition.data.main_action.data.message.sms_quiet_hours_enabled' | 'definition.data.main_action.data.message.sound' | 'definition.data.main_action.data.message.subject_line' | 'definition.data.main_action.data.message.template_id' | 'definition.data.main_action.data.message.title' | 'definition.data.main_action.data.message.transactional' | 'definition.data.main_action.data.message.video_asset_id' | 'definition.data.main_action.data.status' | 'definition.data.main_action.id' | 'definition.data.main_action.links' | 'definition.data.main_action.links.next' | 'definition.data.main_action.temporary_id' | 'definition.data.main_action.type' | 'definition.data.message' | 'definition.data.message.add_info_link' | 'definition.data.message.add_opt_out_language' | 'definition.data.message.add_org_prefix' | 'definition.data.message.add_tracking_params' | 'definition.data.message.additional_filters' | 'definition.data.message.additional_filters.condition_groups' | 'definition.data.message.android_link' | 'definition.data.message.badge' | 'definition.data.message.badge_options' | 'definition.data.message.badge_options.badge_config' | 'definition.data.message.badge_options.set_from_property' | 'definition.data.message.badge_options.value' | 'definition.data.message.bcc_email' | 'definition.data.message.body' | 'definition.data.message.cc_email' | 'definition.data.message.conversion_metric_id' | 'definition.data.message.custom_tracking_params' | 'definition.data.message.dynamic_image' | 'definition.data.message.from_email' | 'definition.data.message.from_label' | 'definition.data.message.headers' | 'definition.data.message.id' | 'definition.data.message.image_id' | 'definition.data.message.include_contact_card' | 'definition.data.message.ios_link' | 'definition.data.message.kv_pairs' | 'definition.data.message.name' | 'definition.data.message.on_open' | 'definition.data.message.preview_text' | 'definition.data.message.push_type' | 'definition.data.message.reply_to_email' | 'definition.data.message.shorten_links' | 'definition.data.message.smart_sending_enabled' | 'definition.data.message.sms_quiet_hours_enabled' | 'definition.data.message.sound' | 'definition.data.message.subject_line' | 'definition.data.message.template_id' | 'definition.data.message.title' | 'definition.data.message.to_emails' | 'definition.data.message.transactional' | 'definition.data.message.url' | 'definition.data.message.vendor_id' | 'definition.data.message.video_asset_id' | 'definition.data.name' | 'definition.data.on_execution' | 'definition.data.profile_filter' | 'definition.data.profile_filter.condition_groups' | 'definition.data.profile_operations' | 'definition.data.secondary_value' | 'definition.data.service_configuration' | 'definition.data.service_configuration.event_key' | 'definition.data.service_configuration.event_payload' | 'definition.data.service_configuration.report_id' | 'definition.data.service_configuration.service_method_type' | 'definition.data.service_configuration.tracking_company_id' | 'definition.data.status' | 'definition.data.target_days' | 'definition.data.target_time' | 'definition.data.timezone' | 'definition.data.trigger_filter' | 'definition.data.trigger_filter.condition_groups' | 'definition.data.trigger_id' | 'definition.data.trigger_subtype' | 'definition.data.trigger_type' | 'definition.data.unit' | 'definition.data.value' | 'definition.id' | 'definition.links' | 'definition.links.next' | 'definition.links.next_if_false' | 'definition.links.next_if_true' | 'definition.temporary_id' | 'definition.type' | 'updated'>, fieldsFlow?: Array<'archived' | 'created' | 'name' | 'status' | 'trigger_type' | 'updated'>, fieldsTag?: Array<'name'>, filter?: string, include?: Array<'flow-actions' | 'tags'>, pageCursor?: string, pageSize?: number, sort?: 'created' | '-created' | 'id' | '-id' | 'name' | '-name' | 'status' | '-status' | 'trigger_type' | '-trigger_type' | 'updated' | '-updated',  } = {}): Promise<{ response: AxiosResponse; body: GetFlowResponseCollectionCompoundDocument;  }> {
     ...
     * @param id 
     * @param filter For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;name&#x60;: &#x60;contains&#x60;, &#x60;ends-with&#x60;, &#x60;equals&#x60;, &#x60;starts-with&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;* @param pageCursor For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#pagination* @param pageSize Default: 50. Min: 1. Max: 50.* @param sort For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sorting
     */
     ...
     * @param id 
     * @param fieldsTag For more information please visit https://developers.klaviyo.com/en/v2026-01-15/reference/api-overview#sparse-fieldsets
     */
     ...
     */
    public async getTemplateForFlowMessage (id: string, options: { fieldsTemplate?: Array<'amp' | 'created' | 'editor_type' | 'html' | 'name' | 'text' | 'updated'>,  } = {}): Promise<{ response: AxiosResponse; body: GetTemplateResponse;  }> {
    ...
    /**
     * Update a flow action.<br><br>*Rate limits*:<br>Burst: `3/s`<br>Steady: `60/m`  **Scopes:** `flows:write`
     * @summary Update Flow Action
     * @param id * @param flowActionUpdateQuery 
     
     */
    public async updateFlowAction (id: string, flowActionUpdateQuery: FlowActionUpdateQuery, ): Promise<{ response: AxiosResponse; body: PatchFlowActionEncodedResponse;  }> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updateFlowAction.');
        }

        // verify required parameter 'flowActionUpdateQuery' is not null or undefined
        if (flowActionUpdateQuery === null || flowActionUpdateQuery === undefined) {
            throw new Error('Required parameter flowActionUpdateQuery was null or undefined when calling updateFlowAction.');
        }
        ...
        let config: AxiosRequestConfig = {
            ...
            headers: localVarHeaderParams,
            params: localVarQueryParameters,
            data: ObjectSerializer.serialize(flowActionUpdateQuery, "FlowActionUpdateQuery")
        }

        await this.session.applyToRequest(config)

        const request = async (config: AxiosRequestConfig, retried = false): Promise<{ response: AxiosResponse; body: PatchFlowActionEncodedResponse;  }> => {
            try {
                const axiosResponse = await this.session.requestWithRetry(config)
                let body;
                body = ObjectSerializer.deserialize(axiosResponse.data, "PatchFlowActionEncodedResponse");
                return ({response: axiosResponse, body: body});
            } catch (error) {
                if (await this.session.refreshAndRetry(error, retried)) {
                    await this.session.applyToRequest(config)
