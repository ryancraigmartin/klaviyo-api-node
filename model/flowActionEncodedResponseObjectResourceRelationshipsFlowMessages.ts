...
export class FlowActionEncodedResponseObjectResourceRelationshipsFlowMessages {
    ...
    static getAttributeTypeMap() {
        return FlowActionEncodedResponseObjectResourceRelationshipsFlowMessages.attributeTypeMap;
    }
}
