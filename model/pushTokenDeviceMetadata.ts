...
export class PushTokenDeviceMetadata {
    /**
    ...
    */
    'klaviyoSdk'?: PushTokenDeviceMetadata.KlaviyoSdkEnum | 'android' | 'flutter' | 'flutter_community' | 'react_native' | 'swift' | null;
    /**
    ...
    */
    'osName'?: PushTokenDeviceMetadata.OsNameEnum | 'android' | 'ios' | 'ipados' | 'macos' | 'tvos' | null;
    /**
    ...
    */
    'environment'?: PushTokenDeviceMetadata.EnvironmentEnum | 'debug' | 'release' | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PushTokenDeviceMetadata.KlaviyoSdkEnum"
        },
        {
            "name": "sdkVersion",
        ...
        },
        {
            "name": "osName",
            "baseName": "os_name",
            "type": "PushTokenDeviceMetadata.OsNameEnum"
        },
        {
            "name": "osVersion",
            "baseName": "os_version",
        ...
        },
        {
            ...
            "type": "PushTokenDeviceMetadata.EnvironmentEnum"
        }    ];

    static getAttributeTypeMap() {
        return PushTokenDeviceMetadata.attributeTypeMap;
    }
}

export namespace PushTokenDeviceMetadata {
